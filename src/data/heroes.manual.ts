// Legacy manual seed retained temporarily for migration reference.
import type { Hero, HeroRole, HeroSkill } from '../types'
...
export const heroes: Hero[] = heroRows.map(([name, roleText]) => {
